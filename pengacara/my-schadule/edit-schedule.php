      ...
      <div class="bg-white shadow-lg rounded-2xl p-8 mt-6 max-w-xl">
        ...
        <form action="#" method="POST" class="space-y-6">
          ...
          <div>
            ...
            <input type="date" id="day" name="day" value="2025-09-15"
          ...
          <div>
            ...
            <input type="time" id="finished" name="finished" value="15:00"
              class="w-full px-4 py-2 border rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-black">
          </div>

          <!-- Buttons -->
          <div class="flex justify-end space-x-4">
            <a href="./my-schedule.php" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
              Cancel
            </a>
            <a href="./my-schedule.php" class="px-6 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">
              Update
            </a>
          </div>
        </form>

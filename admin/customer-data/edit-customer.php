...
<head>
  ...
  <title>Edit Customer - Three Brother Law</title>
    ...
    <main class="flex-1 p-8">
      ...
      <form action="#" class="bg-white p-6 rounded-xl shadow-lg space-y-4 max-w-2xl">
        <div>
          ...
          <input type="text" class="w-full px-3 py-2 border rounded bg-gray-200" value="5764890" readonly>
        </div>

        <div>
          <label class="block font-semibold">Customer Name</label>
          <input type="text" class="w-full px-3 py-2 border rounded bg-gray-200" value="Supriadi Juli">
        </div>

        <div>
          <label class="block font-semibold">Address</label>
          <input type="text" class="w-full px-3 py-2 border rounded bg-gray-200" value="Jl. Rungkut Indah 19">
        </div>

        <div>
          <label class="block font-semibold">Phone Number</label>
          <input type="text" class="w-full px-3 py-2 border rounded bg-gray-200" value="+62824989131">
        </div>

        <!-- Buttons -->
        <div class="flex justify-end space-x-3 pt-4">
          <a href="./customer-data.php" type="button" class="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700">Cancel</a>
          <a href="./customer-data.php" type="submit" class="bg-gray-600 text-white px-6 py-2 rounded hover:bg-gray-700">Save Changes</a>
        </div>
      </form>
    </main>
  </div>
